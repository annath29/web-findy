...
const Details = () => {
  ...
  useEffect(() => {
    getCommentsByPostIdSort(idPost)
      .then((response) => {
        console.log("object",response)
        setSortComments(response);
      })
      .catch((e) => console.error(e));
  }, []);
  ...
  return (
    ...
    >
        ...
        <CardHeader
          ...
          action={
            <Box component="div" sx={{ display: "flex", flexDirection: "row" }}>
              <IconButton
                onClick={() => handleLike(post.id, user.user.user.id)}
              ...
              >
                ...
                <Typography variant="body2" color="text.dark" mt={0.5}>
      ...
      <CardHeader
        sx={{ padding: "10px 16px", width: "100vw"}}
        avatar={
        ...
        title={<FormComments post={post} idUser={user.user.user?.id} />}
      />
